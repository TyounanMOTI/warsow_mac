...
/* version */
#define Q3MAP_VERSION	"2.5.17.qfusion"
#define Q3MAP_MOTD		"Last one turns the lights off"

/* jal: some switches we kept disabled */

//#define LIGHTGRID_SEARCH_FIX /* jal: I'm not so convinced about this fix */
//#define BOUNCEGRID_DIRECTIONALITY /* jal: I'm also not convinced about bouncing adding to grid directionality */
...
// jal: remove gtkradiant's version.h
/* general */
...
#define	MAX_PORTALS_ON_LEAF		512		/* jal: was 128. q3map2n uses 1024 */
...
typedef struct game_s
{
	...
	qboolean			lightAngleHL;					/* when true, use half lambert curve for angle attenuation */
	...
	float				backSplashFraction;				/* jal: default backsplash of surface lights */
	...
	qboolean            miniMapKeepAspect;
	miniMapMode_t       miniMapMode;
	char                *miniMapNameFormat;
...
Q_EXTERN int				minSampleSize;
Q_EXTERN int				sampleScale;	
...
Q_EXTERN qboolean			floodlightMultipass Q_ASSIGN( qfalse );
...
Q_EXTERN float				floodlightScale Q_ASSIGN( 1.0f );
...
Q_EXTERN qboolean			lightAngleHL Q_ASSIGN( qtrue );

/* jal: default backsplash fraction */
Q_EXTERN float				backSplashFraction Q_ASSIGN( DEF_BACKSPLASH_FRACTION );
